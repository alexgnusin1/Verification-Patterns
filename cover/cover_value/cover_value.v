module cover_value (clk, rst_n, data);
...
reg [31:0]        cover_val_mem   [0:COVER_NUM-1];
...
begin
  ...
  cover_val_mem[cover_id] = cover_value;
...
begin
  total_cov = 0;
  $display("");
  $display("		Value Coverage Report <%m>");
  $display("--------------------------------------------------------------------------");
